...
$(".navicon").on("click", function(a) {
    a.preventDefault(), $(".main-navigation").toggleClass("open-menu"), $("#hamburger").toggleClass("open-menu"), 
...
!function(a) {
    ...
    j.defaults = {
        ...
        var b = this.guid = ++n;
        this.element.flickityGUID = b, o[b] = this, this.selectedIndex = 0, this.restingFrames = 0, 
        ...
        if (!this.isActive) {
            ...
            this.reloadCells(), this.options.accessibility && (this.element.tabIndex = 0, d.bind(this.element, "keydown", this)), 
            this.emit("activate");
            var c, e = this.options.initialIndex;
            c = this.isInitActivated ? this.selectedIndex : void 0 !== e && this.cells[e] ? e : 0, 
            this.select(c, !1, !0), this.isInitActivated = !0;
        }
    ...
    j.prototype.setCellAlign = function() {
        ...
        if (this.isActive) {
            ...
            this.options.wrapAround && d > 1 && (0 > a ? this.x -= this.slideableWidth : a >= d && (this.x += this.slideableWidth)), 
            (this.options.wrapAround || b) && (a = f.modulo(a, d)), this.cells[a] && (this.selectedIndex = a, 
            this.setSelectedCell(), c ? this.positionSliderAtSelected() : this.startAnimation(), 
        ...
        for (var d = [], e = b - a; b + a >= e; e++) {
            var g = this.options.wrapAround ? f.modulo(e, c) : e, h = this.cells[g];
            h && d.push(h.element);
        }
        return d;
    ...
    f.prototype.pointerDown = function(c, d) {
        if ("INPUT" == c.target.nodeName && "range" == c.target.type) return this.isPointerDown = !1, 
        void delete this.pointerIdentifier;
        this._dragPointerDown(c, d);
        var e = document.activeElement;
        e && e.blur && e.blur(), this._bindPostStartEvents(c), this.pointerDownScroll = f.getScrollPosition(), 
        b.bind(a, "scroll", this), this.emitEvent("pointerDown", [ c, d ]);
        ...
        if (!this.isIgnoringMouseUp || "mouseup" != a.type) {
            ...
            if (("INPUT" == c || "TEXTAREA" == c) && a.target.focus(), this.staticClick(a, b), 
            "mouseup" != a.type) {
        ...
        var a = f.getScrollPosition(), b = this.pointerDownScroll.x - a.x, c = this.pointerDownScroll.y - a.y;
    ...
    f.extend(d.defaults, {
        ...
        if ("INPUT" == d.target.nodeName && "range" == d.target.type) return this.isPointerDown = !1, 
        void delete this.pointerIdentifier;
        this._dragPointerDown(d, f);
        var g = document.activeElement;
        g && g.blur && g != this.element && g != document.body && g.blur(), this.pointerDownFocus(d), 
        this.dragX = this.x, b.add(this.viewport, "is-pointer-down"), this._bindPostStartEvents(d), 
        this.pointerDownScroll = e.getScrollPosition(), c.bind(a, "scroll", this), this.dispatchEvent("pointerDown", d, [ f ]);
    };
    var i = {
        touchstart: !0,
        MSPointerDown: !0
    ...
    return d.prototype.touchVerticalScrollMove = function(b, c, d) {
        ...
        var a = this.getCellDistance(-this.dragX, this.selectedIndex), b = this.previousDragX - this.dragX;
    ...
    var h = "http://www.w3.org/2000/svg", i = function() {
        function a() {
    ...
    return f.prototype = new d(), f.prototype._create = function() {
        ...
        b.setAttribute("type", "button"), this.disable(), c.setUnselectable(b), i()) {
        ...
        var b = document.createElementNS(h, "path"), c = g(this.parent.options.arrowShape);
        return b.setAttribute("d", c), b.setAttribute("class", "arrow"), this.isLeft || b.setAttribute("transform", "translate(100, 100) rotate(180) "), 
        a.appendChild(b), a;
    ...
    var f, g;
    return "hidden" in document ? (f = "hidden", g = "visibilitychange") : "webkitHidden" in document && (f = "webkitHidden", 
    g = "webkitvisibilitychange"), e.prototype = new a(), e.prototype.play = function() {
        this.isPlaying = !0, delete this.isPaused, g && document.addEventListener(g, this.onVisibilityChange, !1), 
        this.tick();
        ...
        this.player = new e(this), this.on("activate", this.activatePlayer), this.on("uiChange", this.stopPlayer), 
    ...
    return b.prototype.insert = function(a, b) {
        ...
        this.emitEvent("cellAddedRemoved", [ a, b ]), this.cellChange(a, !0);
        ...
        this._positionCells(a), this._getWrapShiftCells(), this.setGallerySize(), this.options.freeScroll ? (this.x += c - this.slideableWidth, 
        this.positionSlider()) : (b && this.positionSliderAtSelected(), this.select(this.selectedIndex));
    }, b;
}), function(a, b) {
    "use strict";
    ...
    return d.createMethods.push("_createLazyload"), d.prototype._createLazyload = function() {
        ...
        c.bind(this.img, "load", this), c.bind(this.img, "error", this), this.img.src = this.img.getAttribute("data-flickity-lazyload"), 
        ...
        var e = this.flickity.getParentCell(this.img), f = e && e.element;
    ...
    return g.prototype.addImage = function(a) {
        ...
        this.progressedCount++, this.hasAnyBroken = this.hasAnyBroken || !a.isLoaded, this.emit("progress", this, a, b), 
...
$(".home-slider").flickity({
    ...
    a.preventDefault(), $(".main-nav").toggleClass("open-menu"), $("#hamburger").toggleClass("open-menu"), 
    $("body").toggleClass("no-scroll");
